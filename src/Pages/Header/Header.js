...
const Header = () => {
    ...
    return (
        <Navbar className='py-2 fs-4 navbar-bg' bg='success' sticky='top' expand="lg">
            <Container>
                <Navbar.Brand as={Link} to="/" className='fs-3 fw-bold text-white logo'>Fruits Warehouse</Navbar.Brand>
